...
const tabs = [
  {
    ...
    icon: (
      <path
        ...
        d="M2.25 3h1.5l1.6 9.6a1.5 1.5 0 0 0 1.48 1.25h8.6a1.5 1.5 0 0 0 1.46-1.16L18.6 6H4.9M9 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm8.25 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"
      />
    ),
  },
  {
    ...
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="m20.25 7.5-.63 10.03a2.25 2.25 0 0 1-2.24 2.12H6.62a2.25 2.25 0 0 1-2.24-2.12L3.75 7.5m8.25 3v6.75m-4.5-6.75.38 6.75m8.62-6.75-.38 6.75M3.375 7.5h17.25c.62 0 1.125-.5 1.125-1.125v-1.5c0-.62-.5-1.125-1.125-1.125H3.375c-.62 0-1.125.5-1.125 1.125v1.5c0 .62.5 1.125 1.125 1.125Z"
      />
    ),
  },
  {
